...
```
Index: src/test/java/org/appfuse/tutorial/webapp/pages/PersonListTest.java
===================================================================
--- src/test/java/org/appfuse/tutorial/webapp/pages/PersonListTest.java	(revision 85)
+++ src/test/java/org/appfuse/tutorial/webapp/pages/PersonListTest.java	(working copy)
@@ -29,7 +29,7 @@
...
Index: src/test/resources/config.xml
===================================================================
--- src/test/resources/config.xml	(revision 85)
+++ src/test/resources/config.xml	(working copy)
@@ -2,4 +2,5 @@
...
+                <invoke description="click View Users link" url="/admin/UserList.html"/>
...
+                <clickbutton htmlid="register" description="Click button 'Signup'"/>
...
+                <invoke description="get flushCache URL" url="/admin/flushCache.jsp"/>
...
-                <setFileField description="set file" name="fileField" fileName="pom.xml"/>
...
+                <setinputfield description="set firstName" name="firstName" value="firstName"/>

+                <setinputfield description="set lastName" name="lastName" value="lastName"/>
...
+                <setinputfield description="set firstName" name="firstName" value="Canoo"/>

+                <setinputfield description="set lastName" name="lastName" value="Test"/>
...
-        <to type="redirect">/flushCache.jsp</to>
...
@@ -7,13 +7,13 @@
         ...
         <Menu name="UserMenu" title="menu.user" description="User Menu" page="mainMenu,$DirectLink.sdirect" roles="ROLE_ADMIN,ROLE_USER"/>

         <Menu name="PeopleMenu" title="menu.viewPeople" page="/PersonList.html"/>

-        <Menu name="AdminMenu" title="menu.admin" description="Admin Menu" roles="ROLE_ADMIN" width="120" page="/UserList.html">
...
+        <Menu name="AdminMenu" title="menu.admin" description="Admin Menu" roles="ROLE_ADMIN" width="120" page="/admin/UserList.html">

+            <Item name="ViewUsers" title="menu.admin.users" page="/admin/UserList.html"/>
...
+    <!-- Tapestry already gzips the files it serves, so just gzip css and javascript -->
...
Index: src/main/webapp/WEB-INF/tapestry.application
===================================================================
--- src/main/webapp/WEB-INF/tapestry.application	(revision 85)
+++ src/main/webapp/WEB-INF/tapestry.application	(working copy)
@@ -8,7 +8,8 @@
     ...
     <meta key="org.apache.tapestry.page-class-packages" value="org.appfuse.webapp.pages,org.appfuse.tutorial.webapp.pages"/>
...
+                <jdbc.url><![CDATA[jdbc:derby://localhost/tutorial_tapestry;create=true]]></jdbc.url>
...
-                <jdbc.url><![CDATA[jdbc:h2:tutorial-tapestry]]></jdbc.url>

+                <jdbc.url><![CDATA[jdbc:h2:tutorial_tapestry]]></jdbc.url>
...
-                <jdbc.url><![CDATA[jdbc:hsqldb:tutorial-tapestry;shutdown=true]]></jdbc.url>

+                <jdbc.url><![CDATA[jdbc:hsqldb:tutorial_tapestry;shutdown=true]]></jdbc.url>
...
-                <jdbc.url><![CDATA[jdbc:postgresql://localhost/tutorial-tapestry]]></jdbc.url>

+                <jdbc.url><![CDATA[jdbc:postgresql://localhost/tutorial_tapestry]]></jdbc.url>
...
-                <jdbc.url><![CDATA[jdbc:jtds:sqlserver://localhost:3683/tutorial-tapestry]]></jdbc.url>

+                <jdbc.url><![CDATA[jdbc:jtds:sqlserver://localhost:3683/tutorial_tapestry]]></jdbc.url>
...
+        <jdbc.url><![CDATA[jdbc:mysql://localhost/tutorial_tapestry?createDatabaseIfNotExist=true&amp;useUnicode=true&amp;characterEncoding=utf-8]]></jdbc.url>
